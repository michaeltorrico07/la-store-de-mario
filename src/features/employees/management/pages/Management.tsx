...
export const Management = () => {
  ...
  const { data: allProducts, loading } = useGetAllProduct();
  ...
  return (
    <div className="max-w-3xl mx-auto p-4 flex flex-col gap-2 mb-10">
      <h1 className="text-2xl font-bold mb-4">Administrar Productos</h1>
      <LoadingContent loading={loading} className="flex flex-col gap-2">
